...
Begin VB.Form frmNewColour 
   ...
   End
End
Attribute VB_Name = "frmNewColour"
...
If txtTextHilite.Text <> "" Then
    frmMain.lstColourTrig.AddItem txtTextHilite.Text
    frmMain.lstColours.AddItem shaColour.FillColor
    frmNewColour.Hide
    txtTextHilite.Text = ""
